...
MAIN(goahead, int argc, char **argv, char **envp)
{
    ...
    websUrlHandlerDefine(T("/goform"), 0, 0, websFormHandler, 0);
...
/*
    Implement /goform/formTest. Parse the form variables: name, address and echo back.
 */
static void formTest(webs_t wp, char_t *path, char_t *query)
{
	char_t	*name, *address;
