...
#
ifeq ($(BIT_PACK_EST),1)
    DEPS_8 += $(CONFIG)/bin/libest.dylib
endif
...
$(CONFIG)/bin/goahead: $(DEPS_34)
	...
	$(CC) -o $(CONFIG)/bin/goahead -arch x86_64 $(LDFLAGS) $(LIBPATHS)    $(CONFIG)/obj/goahead.o $(LIBPATHS_34) $(LIBS_34) $(LIBS_34) $(LIBS) -lpam 
...
$(CONFIG)/bin/goahead-test: $(DEPS_36)
	...
	$(CC) -o $(CONFIG)/bin/goahead-test -arch x86_64 $(LDFLAGS) $(LIBPATHS)    $(CONFIG)/obj/test.o $(LIBPATHS_36) $(LIBS_36) $(LIBS_36) $(LIBS) -lpam 
...
$(CONFIG)/bin/gopass: $(DEPS_38)
	...
	$(CC) -o $(CONFIG)/bin/gopass -arch x86_64 $(LDFLAGS) $(LIBPATHS)    $(CONFIG)/obj/gopass.o $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) 
