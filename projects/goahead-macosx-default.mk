...
$(CONFIG)/inc/est.h: 
	mkdir -p "/Users/mob/git/goahead/macosx-x64-default/inc"
	cp "src/deps/est/est.h" "/Users/mob/git/goahead/macosx-x64-default/inc/est.h"

$(CONFIG)/inc/bit.h: 

$(CONFIG)/inc/bitos.h: 
	mkdir -p "/Users/mob/git/goahead/macosx-x64-default/inc"
	cp "src/bitos.h" "/Users/mob/git/goahead/macosx-x64-default/inc/bitos.h"
...
$(CONFIG)/bin/ca.crt: \
    src/deps/est/ca.crt
	mkdir -p "/Users/mob/git/goahead/macosx-x64-default/bin"
	cp "src/deps/est/ca.crt" "/Users/mob/git/goahead/macosx-x64-default/bin/ca.crt"

$(CONFIG)/inc/goahead.h: 
	mkdir -p "/Users/mob/git/goahead/macosx-x64-default/inc"
	cp "src/goahead.h" "/Users/mob/git/goahead/macosx-x64-default/inc/goahead.h"

$(CONFIG)/inc/js.h: 
	mkdir -p "/Users/mob/git/goahead/macosx-x64-default/inc"
	cp "src/js.h" "/Users/mob/git/goahead/macosx-x64-default/inc/js.h"
...
uninstall: stop
	rmdir -p "/usr/local/lib/goahead"
	rmdir -p "/usr/local/lib/goahead/3.1.0"
	rmdir -p "/etc/goahead"
