...
clean:
	...
	rm -f "build/$(CONFIG)/bin/libgo.dylib"
...
build/$(CONFIG)/obj/cgitest.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/cgitest.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) test/cgitest.c
...
test/cgi-bin/cgitest: $(DEPS_6)
	...
	$(CC) -o test/cgi-bin/cgitest -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/cgitest.o" $(LIBS) 
...
build/$(CONFIG)/bin/libest.dylib: $(DEPS_10)
	@echo '      [Link] build/$(CONFIG)/bin/libest.dylib'
	$(CC) -dynamiclib -o build/$(CONFIG)/bin/libest.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libest.dylib -compatibility_version 3.4 -current_version 3.4 "build/$(CONFIG)/obj/estLib.o" $(LIBS) 
endif
...
build/$(CONFIG)/obj/action.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/action.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/action.c
...
build/$(CONFIG)/obj/alloc.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/alloc.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/alloc.c
...
build/$(CONFIG)/obj/auth.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/auth.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/auth.c
...
build/$(CONFIG)/obj/cgi.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/cgi.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/cgi.c
...
build/$(CONFIG)/obj/crypt.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/crypt.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/crypt.c
...
build/$(CONFIG)/obj/file.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/file.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/file.c
...
build/$(CONFIG)/obj/fs.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/fs.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/fs.c
...
build/$(CONFIG)/obj/http.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/http.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/http.c
...
build/$(CONFIG)/obj/js.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/js.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/js.c
...
build/$(CONFIG)/obj/jst.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/jst.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/jst.c
...
build/$(CONFIG)/obj/options.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/options.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/options.c
...
build/$(CONFIG)/obj/osdep.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/osdep.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/osdep.c
...
build/$(CONFIG)/obj/rom-documents.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/rom-documents.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/rom-documents.c
...
build/$(CONFIG)/obj/route.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/route.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/route.c
...
build/$(CONFIG)/obj/runtime.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/runtime.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/runtime.c
...
build/$(CONFIG)/obj/socket.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/socket.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/socket.c
...
build/$(CONFIG)/obj/est.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/est.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/est.c
...
build/$(CONFIG)/obj/matrixssl.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/matrixssl.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/matrixssl.c
...
build/$(CONFIG)/obj/nanossl.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/nanossl.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/nanossl.c
...
build/$(CONFIG)/obj/openssl.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/openssl.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/openssl.c
...
build/$(CONFIG)/obj/upload.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/upload.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/upload.c
...
ifeq ($(ME_COM_EST),1)
    DEPS_32 += build/$(CONFIG)/bin/libest.dylib
endif
...
build/$(CONFIG)/obj/goahead.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/goahead.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/goahead.c
...
ifeq ($(ME_COM_EST),1)
    DEPS_34 += build/$(CONFIG)/bin/libest.dylib
endif
...
DEPS_34 += build/$(CONFIG)/bin/libgo.dylib
...
build/$(CONFIG)/bin/goahead: $(DEPS_34)
	...
	$(CC) -o build/$(CONFIG)/bin/goahead -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "build/$(CONFIG)/obj/goahead.o" $(LIBPATHS_34) $(LIBS_34) $(LIBS_34) $(LIBS) 
...
build/$(CONFIG)/obj/test.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/test.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" test/test.c
...
ifeq ($(ME_COM_EST),1)
    DEPS_36 += build/$(CONFIG)/bin/libest.dylib
endif
...
DEPS_36 += build/$(CONFIG)/bin/libgo.dylib
...
build/$(CONFIG)/bin/goahead-test: $(DEPS_36)
	...
	$(CC) -o build/$(CONFIG)/bin/goahead-test -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "build/$(CONFIG)/obj/test.o" $(LIBPATHS_36) $(LIBS_36) $(LIBS_36) $(LIBS) 
...
build/$(CONFIG)/obj/gopass.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/gopass.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/utils/gopass.c
...
ifeq ($(ME_COM_EST),1)
    DEPS_38 += build/$(CONFIG)/bin/libest.dylib
endif
...
DEPS_38 += build/$(CONFIG)/bin/libgo.dylib
...
build/$(CONFIG)/bin/gopass: $(DEPS_38)
	...
	$(CC) -o build/$(CONFIG)/bin/gopass -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "build/$(CONFIG)/obj/gopass.o" $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) 
...
installBinary: $(DEPS_40)
	...
	cp build/$(CONFIG)/bin/libgo.dylib $(ME_VAPP_PREFIX)/bin/libgo.dylib ; \
