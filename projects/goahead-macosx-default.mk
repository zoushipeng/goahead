...
prep:
	...
	@[ ! -f $(CONFIG)/inc/me.h ] && cp projects/goahead-macosx-default-me.h $(CONFIG)/inc/me.h ; true
	@if ! diff $(CONFIG)/inc/me.h projects/goahead-macosx-default-me.h >/dev/null ; then\
		cp projects/goahead-macosx-default-me.h $(CONFIG)/inc/me.h  ; \
	fi; true
...
$(CONFIG)/bin/libest.dylib: $(DEPS_6)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libest.dylib -arch $(CC_ARCH) -Wl,-rpath,@executable_path/ -Wl,-rpath,@loader_path/ $(LIBPATHS) -install_name @rpath/libest.dylib -compatibility_version 3.3.1 -current_version 3.3.1 "$(CONFIG)/obj/estLib.o" $(LIBS) 
endif
...
$(CONFIG)/obj/action.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/action.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/action.c
...
$(CONFIG)/obj/alloc.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/alloc.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/alloc.c
...
$(CONFIG)/obj/auth.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/auth.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/auth.c
...
$(CONFIG)/obj/cgi.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/cgi.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/cgi.c
...
$(CONFIG)/obj/crypt.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/crypt.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/crypt.c
...
$(CONFIG)/obj/file.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/file.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/file.c
...
$(CONFIG)/obj/fs.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/fs.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/fs.c
...
$(CONFIG)/obj/http.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/http.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/http.c
...
$(CONFIG)/obj/js.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/js.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/js.c
...
$(CONFIG)/obj/jst.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/jst.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/jst.c
...
$(CONFIG)/obj/options.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/options.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/options.c
...
$(CONFIG)/obj/osdep.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/osdep.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/osdep.c
...
$(CONFIG)/obj/rom-documents.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/rom-documents.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/rom-documents.c
...
$(CONFIG)/obj/route.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/route.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/route.c
...
$(CONFIG)/obj/runtime.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/runtime.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/runtime.c
...
$(CONFIG)/obj/socket.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/socket.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/socket.c
...
$(CONFIG)/obj/upload.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/upload.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/upload.c
...
$(CONFIG)/obj/est.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/est.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/est.c
...
$(CONFIG)/obj/matrixssl.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/matrixssl.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/matrixssl.c
...
$(CONFIG)/obj/nanossl.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/nanossl.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/nanossl.c
...
$(CONFIG)/obj/openssl.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/openssl.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/openssl.c
...
$(CONFIG)/obj/goahead.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/goahead.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/goahead.c
...
$(CONFIG)/bin/goahead: $(DEPS_32)
	...
	$(CC) -o $(CONFIG)/bin/goahead -arch $(CC_ARCH) -Wl,-rpath,@executable_path/ -Wl,-rpath,@loader_path/ $(LIBPATHS)    "$(CONFIG)/obj/goahead.o" $(LIBPATHS_32) $(LIBS_32) $(LIBS_32) $(LIBS) 
...
$(CONFIG)/obj/test.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/test.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" test/test.c
...
$(CONFIG)/bin/goahead-test: $(DEPS_34)
	...
	$(CC) -o $(CONFIG)/bin/goahead-test -arch $(CC_ARCH) -Wl,-rpath,@executable_path/ -Wl,-rpath,@loader_path/ $(LIBPATHS)    "$(CONFIG)/obj/test.o" $(LIBPATHS_34) $(LIBS_34) $(LIBS_34) $(LIBS) 
...
$(CONFIG)/obj/gopass.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/gopass.o -arch $(CC_ARCH) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/utils/gopass.c
...
$(CONFIG)/bin/gopass: $(DEPS_36)
	...
	$(CC) -o $(CONFIG)/bin/gopass -arch $(CC_ARCH) -Wl,-rpath,@executable_path/ -Wl,-rpath,@loader_path/ $(LIBPATHS)    "$(CONFIG)/obj/gopass.o" $(LIBPATHS_36) $(LIBS_36) $(LIBS_36) $(LIBS) 
