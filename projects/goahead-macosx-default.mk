...
$(BUILD)/bin/libest.dylib: $(DEPS_33)
...
ifeq ($(ME_COM_EST),1)
    DEPS_34 += $(BUILD)/bin/libest.dylib
endif
...
DEPS_34 += $(BUILD)/obj/matrixssl.o
DEPS_34 += $(BUILD)/obj/nanossl.o
