...
$(CONFIG)/bin/libgo.dylib: $(DEPS_33)
	@echo '      [Link] libgo'
...
$(CONFIG)/bin/goahead: $(DEPS_34)
	@echo '      [Link] goahead'
	$(CC) -o $(CONFIG)/bin/goahead -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/goahead.o $(LIBS_34) $(LIBS_34) $(LIBS) -lpam
...
$(CONFIG)/bin/goahead-test: $(DEPS_36)
	...
	$(CC) -o $(CONFIG)/bin/goahead-test -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/test.o $(LIBS_36) $(LIBS_36) $(LIBS) -lpam
...
$(CONFIG)/bin/gopass: $(DEPS_38)
	@echo '      [Link] gopass'
	$(CC) -o $(CONFIG)/bin/gopass -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/gopass.o $(LIBS_38) $(LIBS_38) $(LIBS) -lest
