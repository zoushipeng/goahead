...
$(CONFIG)/bin/libest.dylib:  \
        $(CONFIG)/inc/est.h \
        $(CONFIG)/obj/estLib.o
	$(DFLAGS)$(CC) -dynamiclib -o $(CONFIG)/bin/libest.dylib -arch x86_64 $(LDFLAGS) -compatibility_version 3.1.0 -current_version 3.1.0 -compatibility_version 3.1.0 -current_version 3.1.0 $(LIBPATHS) -install_name @rpath/libest.dylib $(CONFIG)/obj/estLib.o $(LIBS)
