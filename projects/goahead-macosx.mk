...
$(CONFIG)/obj/test.o: \
        test/test.c \
        $(CONFIG)/inc/bit.h
	$(CC) -c -o $(CONFIG)\obj\test.o -arch x86_64 $(CFLAGS) $(DFLAGS) -I$(CONFIG)\inc test/test.c
...
$(CONFIG)/bin/goahead-test:  \
        ...
        $(CONFIG)/inc/js.h \
        $(CONFIG)/obj/test.o
	$(CC) -o $(CONFIG)\bin\goahead-test -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)\obj\test.o -lgo $(LIBS)
