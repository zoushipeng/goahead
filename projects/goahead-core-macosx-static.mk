#
#   goahead-core-macosx-static.mk -- Makefile to build Embedthis GoAhead Core for macosx
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/goahead-core-macosx-static-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/goahead-core-macosx-static-me.h >/dev/null ; then\
		cp projects/goahead-core-macosx-static-me.h $(BUILD)/inc/me.h  ; \
	fi; true
