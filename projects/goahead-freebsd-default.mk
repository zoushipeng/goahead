...
$(CONFIG)/obj/action.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/action.o -fPIC $(LDFLAGS) $(DFLAGS) $(IFLAGS) src/action.c
...
$(CONFIG)/obj/alloc.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/alloc.o -fPIC $(LDFLAGS) $(DFLAGS) $(IFLAGS) src/alloc.c
...
$(CONFIG)/obj/cgi.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/cgi.o -fPIC $(LDFLAGS) $(DFLAGS) $(IFLAGS) src/cgi.c
...
$(CONFIG)/obj/js.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/js.o -fPIC $(LDFLAGS) $(DFLAGS) $(IFLAGS) src/js.c
...
$(CONFIG)/obj/jst.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/jst.o -fPIC $(LDFLAGS) $(DFLAGS) $(IFLAGS) src/jst.c
...
$(CONFIG)/obj/options.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/options.o -fPIC $(LDFLAGS) $(DFLAGS) $(IFLAGS) src/options.c
...
$(CONFIG)/obj/osdep.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/osdep.o -fPIC $(LDFLAGS) $(DFLAGS) $(IFLAGS) src/osdep.c
...
$(CONFIG)/obj/rom-documents.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/rom-documents.o -fPIC $(LDFLAGS) $(DFLAGS) $(IFLAGS) src/rom-documents.c
...
$(CONFIG)/obj/runtime.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/runtime.o -fPIC $(LDFLAGS) $(DFLAGS) $(IFLAGS) src/runtime.c
...
$(CONFIG)/obj/upload.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/upload.o -fPIC $(LDFLAGS) $(DFLAGS) $(IFLAGS) src/upload.c
...
$(CONFIG)/bin/goahead: $(DEPS_33)
	@echo '      [Link] goahead'
	$(CC) -o $(CONFIG)/bin/goahead $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/goahead.o $(LIBS_33) $(LIBS_33) $(LIBS) -lpthread -lm -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/goahead-test: $(DEPS_35)
	...
	$(CC) -o $(CONFIG)/bin/goahead-test $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/test.o $(LIBS_35) $(LIBS_35) $(LIBS) -lpthread -lm -ldl $(LDFLAGS) 
...
$(CONFIG)/obj/gopass.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/gopass.o -fPIC $(LDFLAGS) $(DFLAGS) $(IFLAGS) src/utils/gopass.c
...
$(CONFIG)/bin/gopass: $(DEPS_37)
	@echo '      [Link] gopass'
	$(CC) -o $(CONFIG)/bin/gopass $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/gopass.o $(LIBS_37) $(LIBS_37) $(LIBS) -lpthread -lm -ldl $(LDFLAGS) 
