...
$(CONFIG)/bin/goahead: $(DEPS_34)
	...
	$(CC) -o $(CONFIG)/bin/goahead $(LDFLAGS) $(LIBPATHS)    $(CONFIG)/obj/goahead.o $(LIBPATHS_34) $(LIBS_34) $(LIBS_34) $(LIBS) -lpthread -lm -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/goahead-test: $(DEPS_36)
	...
	$(CC) -o $(CONFIG)/bin/goahead-test $(LDFLAGS) $(LIBPATHS)    $(CONFIG)/obj/test.o $(LIBPATHS_36) $(LIBS_36) $(LIBS_36) $(LIBS) -lpthread -lm -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/gopass: $(DEPS_38)
	...
	$(CC) -o $(CONFIG)/bin/gopass $(LDFLAGS) $(LIBPATHS)    $(CONFIG)/obj/gopass.o $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) -lpthread -lm -ldl $(LDFLAGS) 
