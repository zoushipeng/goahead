#
#   goahead-core-vxworks-static.mk -- Makefile to build Embedthis GoAhead Core for vxworks
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/goahead-core-vxworks-static-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/goahead-core-vxworks-static-me.h >/dev/null ; then\
		cp projects/goahead-core-vxworks-static-me.h $(BUILD)/inc/me.h  ; \
	fi; true
