/*
    me.h -- MakeMe Configure Header for windows-x64-openssl_11
...
/* Profile */
    ...
    #define ME_CONFIG_CMD "me -d -q -platform windows-x64-openssl_11 -configure . --set openssl.version=1.1 --with openssl -gen vs"
#endif
#ifndef ME_GOAHEAD_CORE_PRODUCT
    #define ME_GOAHEAD_CORE_PRODUCT 1
#endif
#ifndef ME_PROFILE
    #define ME_PROFILE "openssl_11"
#endif
#ifndef ME_TUNE_SIZE
