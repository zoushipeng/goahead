...
build/$(CONFIG)/obj/action.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/action.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/action.c
...
build/$(CONFIG)/obj/alloc.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/alloc.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/alloc.c
...
build/$(CONFIG)/obj/auth.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/auth.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/auth.c
...
build/$(CONFIG)/obj/cgi.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/cgi.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/cgi.c
...
build/$(CONFIG)/obj/crypt.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/crypt.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/crypt.c
...
build/$(CONFIG)/obj/file.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/file.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/file.c
...
build/$(CONFIG)/obj/fs.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/fs.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/fs.c
...
build/$(CONFIG)/obj/http.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/http.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/http.c
...
build/$(CONFIG)/obj/js.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/js.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/js.c
...
build/$(CONFIG)/obj/jst.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/jst.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/jst.c
...
build/$(CONFIG)/obj/options.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/options.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/options.c
...
build/$(CONFIG)/obj/osdep.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/osdep.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/osdep.c
...
build/$(CONFIG)/obj/rom-documents.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/rom-documents.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/rom-documents.c
...
build/$(CONFIG)/obj/route.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/route.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/route.c
...
build/$(CONFIG)/obj/runtime.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/runtime.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/runtime.c
...
build/$(CONFIG)/obj/socket.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/socket.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/socket.c
...
build/$(CONFIG)/obj/est.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/est.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/est.c
...
build/$(CONFIG)/obj/matrixssl.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/matrixssl.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/matrixssl.c
...
build/$(CONFIG)/obj/nanossl.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/nanossl.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/nanossl.c
...
build/$(CONFIG)/obj/openssl.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/openssl.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/openssl.c
...
build/$(CONFIG)/obj/upload.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/upload.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/upload.c
...
build/$(CONFIG)/obj/goahead.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/goahead.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/goahead.c
...
build/$(CONFIG)/obj/test.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/test.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" test/test.c
...
build/$(CONFIG)/obj/gopass.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/gopass.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/utils/gopass.c
