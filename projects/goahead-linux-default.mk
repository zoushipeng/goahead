...
$(BUILD)/obj/action.o: \
	...
	$(CC) -c -o $(BUILD)/obj/action.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/action.c
...
$(BUILD)/obj/alloc.o: \
	...
	$(CC) -c -o $(BUILD)/obj/alloc.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/alloc.c
...
$(BUILD)/obj/cgi.o: \
	...
	$(CC) -c -o $(BUILD)/obj/cgi.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/cgi.c
...
$(BUILD)/obj/crypt.o: \
	...
	$(CC) -c -o $(BUILD)/obj/crypt.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/crypt.c
...
$(BUILD)/obj/est.o: \
	...
	$(CC) -c -o $(BUILD)/obj/est.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/est.c
...
$(BUILD)/obj/file.o: \
	...
	$(CC) -c -o $(BUILD)/obj/file.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/file.c
...
$(BUILD)/obj/fs.o: \
	...
	$(CC) -c -o $(BUILD)/obj/fs.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/fs.c
...
$(BUILD)/obj/goahead.o: \
	...
	$(CC) -c -o $(BUILD)/obj/goahead.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/goahead.c
...
$(BUILD)/obj/gopass.o: \
	...
	$(CC) -c -o $(BUILD)/obj/gopass.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/utils/gopass.c
...
$(BUILD)/obj/js.o: \
	...
	$(CC) -c -o $(BUILD)/obj/js.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/js.c
...
$(BUILD)/obj/jst.o: \
	...
	$(CC) -c -o $(BUILD)/obj/jst.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/jst.c
...
$(BUILD)/obj/matrixssl.o: \
	...
	$(CC) -c -o $(BUILD)/obj/matrixssl.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/matrixssl.c
...
$(BUILD)/obj/nanossl.o: \
	...
	$(CC) -c -o $(BUILD)/obj/nanossl.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/nanossl.c
...
$(BUILD)/obj/openssl.o: \
	...
	$(CC) -c -o $(BUILD)/obj/openssl.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/openssl.c
...
$(BUILD)/obj/options.o: \
	...
	$(CC) -c -o $(BUILD)/obj/options.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/options.c
...
$(BUILD)/obj/osdep.o: \
	...
	$(CC) -c -o $(BUILD)/obj/osdep.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/osdep.c
...
$(BUILD)/obj/rom-documents.o: \
	...
	$(CC) -c -o $(BUILD)/obj/rom-documents.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/rom-documents.c
...
$(BUILD)/obj/runtime.o: \
	...
	$(CC) -c -o $(BUILD)/obj/runtime.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/runtime.c
...
$(BUILD)/obj/socket.o: \
	...
	$(CC) -c -o $(BUILD)/obj/socket.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/socket.c
...
$(BUILD)/obj/test.o: \
	...
	$(CC) -c -o $(BUILD)/obj/test.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" test/test.c
...
$(BUILD)/obj/upload.o: \
	...
	$(CC) -c -o $(BUILD)/obj/upload.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/upload.c
