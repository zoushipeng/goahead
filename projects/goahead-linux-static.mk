...
$(CONFIG)/obj/action.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/action.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/action.c
...
$(CONFIG)/obj/alloc.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/alloc.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/alloc.c
...
$(CONFIG)/obj/auth.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/auth.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/auth.c
...
$(CONFIG)/obj/cgi.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/cgi.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/cgi.c
...
$(CONFIG)/obj/crypt.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/crypt.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/crypt.c
...
$(CONFIG)/obj/file.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/file.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/file.c
...
$(CONFIG)/obj/fs.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/fs.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/fs.c
...
$(CONFIG)/obj/http.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/http.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/http.c
...
$(CONFIG)/obj/js.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/js.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/js.c
...
$(CONFIG)/obj/jst.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/jst.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/jst.c
...
$(CONFIG)/obj/options.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/options.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/options.c
...
$(CONFIG)/obj/osdep.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/osdep.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/osdep.c
...
$(CONFIG)/obj/rom-documents.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/rom-documents.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/rom-documents.c
...
$(CONFIG)/obj/route.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/route.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/route.c
...
$(CONFIG)/obj/runtime.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/runtime.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/runtime.c
...
$(CONFIG)/obj/socket.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/socket.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/socket.c
...
$(CONFIG)/obj/upload.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/upload.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/upload.c
...
$(CONFIG)/obj/est.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/est.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/est.c
...
$(CONFIG)/obj/matrixssl.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/matrixssl.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/matrixssl.c
...
$(CONFIG)/obj/nanossl.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/nanossl.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/nanossl.c
...
$(CONFIG)/obj/openssl.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/openssl.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/ssl/openssl.c
...
$(CONFIG)/obj/goahead.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/goahead.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/goahead.c
...
$(CONFIG)/obj/test.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/test.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" test/test.c
...
$(CONFIG)/obj/gopass.o: \
	...
	$(CC) -c $(CFLAGS) $(DFLAGS) -o $(CONFIG)/obj/gopass.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/utils/gopass.c
