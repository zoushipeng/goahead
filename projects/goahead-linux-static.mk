...
$(BUILD)/obj/goahead-matrixssl.o: \
    src/goahead-matrixssl/goahead-matrixssl.c $(DEPS_15)
	@echo '   [Compile] $(BUILD)/obj/goahead-matrixssl.o'
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/goahead-matrixssl.o $(LDFLAGS) $(IFLAGS) src/goahead-matrixssl/goahead-matrixssl.c
...
$(BUILD)/obj/goahead-mbedtls.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/goahead-mbedtls.o $(LDFLAGS) -D_FILE_OFFSET_BITS=64 $(IFLAGS) src/goahead-mbedtls/goahead-mbedtls.c
...
$(BUILD)/obj/goahead-openssl.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/goahead-openssl.o $(LDFLAGS) $(IFLAGS) "-I$(BUILD)/inc" "-I$(ME_COM_OPENSSL_PATH)/include" src/goahead-openssl/goahead-openssl.c
...
DEPS_33 += $(BUILD)/obj/mbedtlsLib.o
...
#
DEPS_36 += $(BUILD)/obj/goahead-matrixssl.o

$(BUILD)/bin/libgoahead-matrixssl.a: $(DEPS_36)
...
ifeq ($(ME_COM_MATRIXSSL),1)
    DEPS_37 += $(BUILD)/bin/libgoahead-matrixssl.a
endif
