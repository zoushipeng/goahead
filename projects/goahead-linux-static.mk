...
$(BUILD)/obj/rom-documents.o: \
	...
	$(CC) -c -o $(BUILD)/obj/rom-documents.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/rom-documents.c
