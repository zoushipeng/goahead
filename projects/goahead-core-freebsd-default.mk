#
#   goahead-core-freebsd-default.mk -- Makefile to build Embedthis GoAhead Core for freebsd
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/goahead-core-freebsd-default-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/goahead-core-freebsd-default-me.h >/dev/null ; then\
		cp projects/goahead-core-freebsd-default-me.h $(BUILD)/inc/me.h  ; \
	fi; true
