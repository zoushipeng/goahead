...
$(CONFIG)/bin/libgo.out: $(DEPS_32)
	@echo '      [Link] $(CONFIG)/bin/libgo.out'
	 -r -o $(CONFIG)/bin/libgo.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/action.o" "$(CONFIG)/obj/alloc.o" "$(CONFIG)/obj/auth.o" "$(CONFIG)/obj/cgi.o" "$(CONFIG)/obj/crypt.o" "$(CONFIG)/obj/file.o" "$(CONFIG)/obj/fs.o" "$(CONFIG)/obj/http.o" "$(CONFIG)/obj/js.o" "$(CONFIG)/obj/jst.o" "$(CONFIG)/obj/options.o" "$(CONFIG)/obj/osdep.o" "$(CONFIG)/obj/rom-documents.o" "$(CONFIG)/obj/route.o" "$(CONFIG)/obj/runtime.o" "$(CONFIG)/obj/socket.o" "$(CONFIG)/obj/upload.o" "$(CONFIG)/obj/est.o" "$(CONFIG)/obj/matrixssl.o" "$(CONFIG)/obj/nanossl.o" "$(CONFIG)/obj/openssl.o" $(LIBS) 
...
$(CONFIG)/bin/goahead.out: $(DEPS_34)
	@echo '      [Link] $(CONFIG)/bin/goahead.out'
	 -o $(CONFIG)/bin/goahead.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/goahead.o" $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/goahead-test.out: $(DEPS_36)
	@echo '      [Link] $(CONFIG)/bin/goahead-test.out'
	 -o $(CONFIG)/bin/goahead-test.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/test.o" $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/gopass.out: $(DEPS_38)
	@echo '      [Link] $(CONFIG)/bin/gopass.out'
	 -o $(CONFIG)/bin/gopass.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/gopass.o" $(LIBS) -Wl,-r 
