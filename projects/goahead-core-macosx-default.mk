#
#   goahead-core-macosx-default.mk -- Makefile to build Embedthis GoAhead Core for macosx
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/goahead-core-macosx-default-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/goahead-core-macosx-default-me.h >/dev/null ; then\
		cp projects/goahead-core-macosx-default-me.h $(BUILD)/inc/me.h  ; \
	fi; true
